...
<title>GESE - Graded Exams in Spoken English - X-Learning Online</title>
...
<a href="https://wa.me/525611470824" class="wa-button" target="_blank">
<div class="wa-icon"><i class="fab fa-whatsapp"></i></div>
</a>

<!-- Header con Navbar (CON EFECTOS NEÓN) -->
...
<li><a class="dropdown-item active" href="GESE.php">TRINITY GESE</a></li>
...
<!-- Hero Section -->
<section class="gese-hero">
<div class="container">
<h1 class="hero-title animate-fade-in-up">Graded Exams in Spoken English (GESE)</h1>
<p class="hero-subtitle animate-fade-in-up" style="animation-delay: 0.2s;">
Examen graduado evaluado por Trinity College London - Certifica tus habilidades de habla y comprensión auditiva
</p>
</div>
</section>
...
<h2 class="section-title">GESE - Trinity College London</h2>
<div class="info-text">
<p>
Este es un examen graduado y evaluado por Trinity College London, diseñado para certificar habilidades de habla y comprensión auditiva en inglés. Es reconocido mundialmente y cuenta con certificación CENNI ante la SEP.
</p>
</div>
</section>
...
<h2 class="section-title">Ventajas del examen GESE</h2>
<div class="ventajas-grid">
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.1s;">
<div class="ventaja-icon"><i class="fas fa-clock"></i></div>
<h3 class="ventaja-title">Rápido de aplicar y evaluar</h3>
<p class="ventaja-desc">Es rápido para aplicar y evaluar, optimizando tu tiempo de certificación.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.2s;">
<div class="ventaja-icon"><i class="fas fa-check-circle"></i></div>
<h3 class="ventaja-title">Solo acredita una entrevista</h3>
<p class="ventaja-desc">Alcanza el nivel esperado con solo acreditar una entrevista personalizada.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.3s;">
<div class="ventaja-icon"><i class="fas fa-comments"></i></div>
<h3 class="ventaja-title">Inglés de la vida real</h3>
<p class="ventaja-desc">Evalúa el uso del inglés en la vida real, no solo conocimientos teóricos.</p>
</div>
...
<h3 class="ventaja-title">Marco Común Europeo</h3>
<p class="ventaja-desc">Se evalúa la gramática bajo los criterios del Marco Común Europeo de Referencia para las Lenguas.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.5s;">
<div class="ventaja-icon"><i class="fas fa-globe-americas"></i></div>
<h3 class="ventaja-title">Reconocimiento mundial</h3>
<p class="ventaja-desc">Es reconocido mundialmente por instituciones educativas y empleadores.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.6s;">
<div class="ventaja-icon"><i class="fas fa-infinity"></i></div>
<h3 class="ventaja-title">Sin fecha de caducidad</h3>
<p class="ventaja-desc">No tiene fecha de caducidad, tu certificación es válida de por vida.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.7s;">
<div class="ventaja-icon"><i class="fas fa-microphone-alt"></i></div>
<h3 class="ventaja-title">Dos habilidades clave</h3>
<p class="ventaja-desc">Evalúa solo 2 habilidades (Speaking y Listening), enfocándose en la comunicación oral.</p>
</div>
</div>
</section>
</div>
...
<p>Visítanos en Querétaro o contáctanos.</p>
