...
<title>TOEFL - Test of English as a Foreign Language - X-Learning Online</title>
...
<li><a class="dropdown-item active" href="TOEFL.php">TOEFL</a></li>
</ul>
</li>
<li class="nav-item dropdown">
...
<!-- Hero Section -->
<section class="toefl-hero">
<div class="container">
<h1 class="hero-title animate-fade-in-up">Test of English as a Foreign Language (TOEFL)</h1>
<p class="hero-subtitle animate-fade-in-up" style="animation-delay: 0.2s;">
Evaluación del Educational Training Service con textos científicos y tecnológicos
</p>
</div>
</section>
...
<div class="container">
<!-- Sección ¿Qué es TOEFL? -->
<section class="info-section animate-slide-left">
<h2 class="section-title">TOEFL - Educational Training Service</h2>
<div class="info-text">
<p>
Es una evaluación que consiste en 130 preguntas de opción múltiple y su evaluación pertenece al Educational Training Service. Este examen utiliza textos científicos y tecnológicos para certificar las habilidades de Reading Comprehension, Grammar Structure y Listening. Además, cuenta con revalidación por una certificación CENNI ante la SEP.
</p>
</div>
</section>
...
<h2 class="section-title">Ventajas del examen TOEFL</h2>
...
<h3 class="ventaja-title">Modalidad flexible</h3>
<p class="ventaja-desc">Se aplica de forma presencial o en línea, adaptándose a tus necesidades.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.2s;">
<div class="ventaja-icon"><i class="fas fa-sync-alt"></i></div>
<h3 class="ventaja-title">Actualización constante</h3>
<p class="ventaja-desc">Motiva a mantenerte actualizado ya que caduca cada 2 años.</p>
</div>
...
<p class="ventaja-desc">El uso del inglés en términos de estructura gramatical se evalúa bajo criterios del Marco Común Europeo.</p>
</div>
...
<h3 class="ventaja-title">Tres habilidades</h3>
<p class="ventaja-desc">Evalúa 3 habilidades del inglés: Reading, Writing y Listening.</p>
</div>
</div>
</section>
</div>
