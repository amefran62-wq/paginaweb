...
<title>CENNI - Certificado Nacional de Idiomas - X-Learning Online</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Hatton:wght@400;600;700&family=Montserrat:wght@400;500;600;700;800&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
...
<!-- Header con Navbar (DEL INDEX) con efectos neón -->
...
<!-- Hero Section -->
<section class="cenni-hero">
<div class="container">
<h1 class="hero-title animate-fade-in-up">Certificado Nacional de Idiomas (CENNI)</h1>
<p class="hero-subtitle animate-fade-in-up" style="animation-delay: 0.2s;">
Tu puerta al reconocimiento oficial SEP - Certifica tu nivel de inglés con validez nacional
</p>
</div>
</section>
...
<div class="container">
<!-- Sección ¿Qué es el CENNI? -->
<section class="info-section animate-slide-left">
<h2 class="section-title">¿Qué es el CENNI?</h2>
<div class="info-text">
<p>
El Certificado Nacional de Nivel de Idioma es un diploma otorgado por la Secretaría de Educación Pública (SEP) que te permite certificar tus conocimientos de inglés a nivel nacional en México. Este documento oficial es reconocido por instituciones educativas, empresas y organismos gubernamentales en todo el territorio nacional.
</p>
<p class="mt-3">
Con el CENNI, obtienes una certificación válida en todo México que respalda tu dominio del idioma inglés ante cualquier institución educativa o empleador.
</p>
</div>
</section>
...
<h2 class="alert-title">¡Importante!</h2>
<p class="alert-text">
Para conseguir la certificación CENNI, solo necesitas presentar tu examen de nivel. En un lapso de 45 días hábiles, podrás obtener tu diploma con validez oficial de la SEP.
</p>
</section>

<!-- Ventajas del CENNI -->
<section class="ventajas-section">
<h2 class="section-title">Ventajas del certificado CENNI</h2>
<div class="ventajas-grid">
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.1s;">
<div class="ventaja-icon"><i class="fas fa-award"></i></div>
<h3 class="ventaja-title">Reconocimiento oficial</h3>
<p class="ventaja-desc">Reconocimiento oficial de la SEP en México, válido en todo el territorio nacional.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.2s;">
<div class="ventaja-icon"><i class="fas fa-briefcase"></i></div>
<h3 class="ventaja-title">Oportunidades laborales</h3>
<p class="ventaja-desc">Mejora las oportunidades laborales en empresas nacionales e internacionales.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.3s;">
<div class="ventaja-icon"><i class="fas fa-graduation-cap"></i></div>
<h3 class="ventaja-title">Requisito académico</h3>
<p class="ventaja-desc">Requisito académico para programas educativos y titulación en universidades.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.4s;">
<div class="ventaja-icon"><i class="fas fa-exchange-alt"></i></div>
<h3 class="ventaja-title">Movilidad académica</h3>
<p class="ventaja-desc">Facilita la movilidad académica y profesional dentro y fuera de México.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.5s;">
<div class="ventaja-icon"><i class="fas fa-wallet"></i></div>
<h3 class="ventaja-title">Accesibilidad</h3>
<p class="ventaja-desc">Accesibilidad en costo y disponibilidad en comparación con otras certificaciones.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.6s;">
<div class="ventaja-icon"><i class="fas fa-chart-line"></i></div>
<h3 class="ventaja-title">Valor profesional</h3>
<p class="ventaja-desc">Aumenta tu valor profesional y credibilidad en el mercado laboral mexicano.</p>
</div>
</div>
</section>
</div>
