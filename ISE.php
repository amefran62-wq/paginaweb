...
<title>ISE - Integrated Skills in English - X-Learning Online</title>
...
<li><a class="dropdown-item active" href="ISE.php">TRINITY ISE</a></li>
...
<!-- Hero Section -->
<section class="ise-hero">
<div class="container">
<h1 class="hero-title animate-fade-in-up">Integrated Skills in English (ISE)</h1>
<p class="hero-subtitle animate-fade-in-up" style="animation-delay: 0.2s;">
Examen de Trinity College London que evalúa las cuatro habilidades del idioma inglés
</p>
</div>
</section>
...
<h2 class="section-title">ISE - Trinity College London</h2>
<div class="info-text">
<p>
Este examen es diseñado y aplicado por Trinity College London. Su evaluación considera las cuatro habilidades del idioma inglés: speaking, writing, reading y listening.
</p>
<p class="mt-3">
No tiene una parte específica de Use of English y se separa el examen en dos módulos: Reading & Writing y Speaking & Listening. Además, esta certificación tiene revalidación CENNI.
</p>
</div>
</section>
...
<h2 class="section-title">Ventajas del examen ISE</h2>
...
<p class="ventaja-desc">Evalúa según los criterios del Marco Común Europeo de Referencia para las Lenguas.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.2s;">
<div class="ventaja-icon"><i class="fas fa-layer-group"></i></div>
<h3 class="ventaja-title">Evaluación integral</h3>
<p class="ventaja-desc">Diseñado para evaluar integralmente el nivel de inglés en tres diferentes niveles.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.3s;">
<div class="ventaja-icon"><i class="fas fa-infinity"></i></div>
<h3 class="ventaja-title">Vigencia de por vida</h3>
<p class="ventaja-desc">Tiene vigencia de por vida, tu certificación no caduca.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.4s;">
<div class="ventaja-icon"><i class="fas fa-certificate"></i></div>
<h3 class="ventaja-title">Certificaciones modulares</h3>
<p class="ventaja-desc">Recibes un certificado por cada dos habilidades que acredites.</p>
</div>
<div class="ventaja-card animate-fade-in-up" style="animation-delay: 0.5s;">
<div class="ventaja-icon"><i class="fas fa-book-open"></i></div>
<h3 class="ventaja-title">Cuatro habilidades completas</h3>
<p class="ventaja-desc">Evalúa las 4 habilidades del inglés: Speaking, Reading, Writing y Listening.</p>
</div>
</div>
</section>
</div>
